...
public class BeJewweled {
	...
	public void Command(String commandtxtfilename)  {
		try {
	...
	private void Exitcommand(String name) {
	...
	private void WriteLeaderBoarFile(String name) {
		try {
	...
	private void readleaderboradfile() {
		try {
